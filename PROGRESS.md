...
### 06/16/2026
After the previous log I decided to completely rework the player controller from a rigidbody system to a unity character controller system. This change has given a much better looking controller. The animations are not the greatest, but I will revist them after I add more things. I am loosing my motivation for the minor details, so I will begin to work on some fun things. The player models have changed from humans to robots. This will allow the "struggle" idea to be based on a crashed ship causing mechanical issues. A month of work may be gone without much progress, but the foundation of the character is now better than ever. Maybe I will skip the logical next step and jump straight to multiplayer?
