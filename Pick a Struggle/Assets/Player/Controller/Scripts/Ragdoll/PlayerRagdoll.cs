...
public class PlayerRagdoll : MonoBehaviour
{
    ...
    private BoneTransform[] _globalBoneTransforms;
    ...
    private void Awake() {
        ...
        _globalBoneTransforms = new BoneTransform[_bones.Length];
        ...
        for(int i = 0; i < _bones.Length; i++) {
            ...
            _globalBoneTransforms[i] = new BoneTransform();
            _randomTimes[i] = 0f;
        }
    ...
    private void ResetingBones() {
        ...
        for(int i = 0; i < _bones.Length; i++) {
            if(_isBroken) {
                ...
                // Keep global positioning accurate
                _globalBoneTransforms[i].Position = _bones[i].position;
                _globalBoneTransforms[i].Rotation = _bones[i].rotation;
            } else {
                _bones[i].localPosition = Vector3.Lerp(
