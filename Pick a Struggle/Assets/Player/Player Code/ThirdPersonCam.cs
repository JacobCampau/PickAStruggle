...
public class ThirdPersonCam : NetworkIdentity 
{
    ...
    protected override void OnSpawned() {
        ...
        combatCam.gameObject.SetActive(isOwner);
        ragdollCam.gameObject.SetActive(isOwner);
    }

    private void Awake()
    {
        _handler = player.GetComponent<PlayerHandler>();
        aiming = false;
    }
    ...
    private void LateUpdate() {
        ...
        if(_handler.playerState == PlayerHandler.EPlayerState.moving) {
        ...
        } else if(_handler.playerState == PlayerHandler.EPlayerState.ragdoll || _handler.playerState == PlayerHandler.EPlayerState.animated){
