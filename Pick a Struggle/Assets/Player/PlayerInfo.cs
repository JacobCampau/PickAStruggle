...
public class PlayerInfo : MonoBehaviour
{
    ...
    float getJumpForce(){return jump_force;}

    // Emotion Gets
    float getEmotionMax(){return emotion_max;}
    float getCurrentEmotion(){return curr_emotion;}
    float getEmotionBuildup(){return total_emotion_buildup;}
    ...
    // Player States Gets
    bool getIsGrounded(){return is_grounded;}
    ...
    // Emotional Sets
    void setEmotionBuildup(){total_emotion_buildup = emotion_buildup + boost_emotion_buildup;}
    ...
    // Player States Sets
    void setIsGrounded(bool new_truth){is_grounded = new_truth;}
